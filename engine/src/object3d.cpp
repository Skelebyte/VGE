...
//   return Vector3(transformation.GetEntry(0, 0), transformation.GetEntry(0,
//   1),
//                  transformation.GetEntry(0, 2));
// }
// Vector3 Transform3D::Up() const {
//   return Vector3(transformation.GetEntry(2, 0), transformation.GetEntry(2,
//   1),
//                  transformation.GetEntry(2, 2));
// }
// Vector3 Transform3D::Forward() const {
//   return Vector3(transformation.GetEntry(1, 0), transformation.GetEntry(1,
//   1),
